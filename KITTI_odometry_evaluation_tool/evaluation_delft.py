...
import KITTI_odometry_evaluation_tool.tools.transformations as tr
from KITTI_odometry_evaluation_tool.tools.pose_evaluation_utils import quat_pose_to_mat


class kittiOdomEval():
    def __init__(self):
        self.gt_dir = './eval_result/ground_truth_pose_delft'
        self.result_dir = './eval_result/data_delft'
        self.eva_seqs = 'delft_1,delft_4,delft_6,delft_9,delft_27'
        # self.eva_seqs = 'delft_4,delft_6,delft_12,delft_19,delft_23,delft_24,delft_26'
        ...
        self.lengths = [20,40,60,80,100,120,140,160]
    ...
    def eval(self, toCameraCoord):
        ...
        pose_metric_kitti = {'TRMSE': 0, 'RRMSE': 0,}
        for key in ave_errs.keys():
            pose_metric_kitti['TRMSE'] += ave_errs[key][0] * 100
            pose_metric_kitti['RRMSE'] += ave_errs[key][1] / np.pi * 180

        pose_metric_kitti['TRMSE'] /= len(ave_errs)
        pose_metric_kitti['RRMSE'] /= len(ave_errs)

        return pose_metric_kitti
